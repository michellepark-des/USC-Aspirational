...
// Unit catalog: each SIZE group contains 3 tiers (Good / Better / Best).
// Tier = quality within a size. A 10x10 exists in all three tiers --
// what differentiates them is proximity, floor, climate control, etc.
const UNIT_GROUPS = [
  {
    id: "5x10",
    size: "Small",
    ...
    units: [
      {
        tier: "Good", tierColor: "#718096", price: 59,
        label: "Standard",
        detail: "Back of facility, upper floor, drive-up access",
        features: ["Drive-up", "Upper floor", "Lock included"],
      },
      {
        tier: "Better", tierColor: "#032046", price: 74, was: 89,
        label: "Convenient",
        detail: "Mid-facility, ground floor, interior hallway access",
        features: ["Interior access", "Ground floor", "Lock included"],
      },
      {
        tier: "Best", tierColor: "#1A8F60", price: 89,
        label: "Premium",
        detail: "Near entrance, ground floor, wide drive-up aisle",
        features: ["Near entrance", "Drive-up", "Ground floor", "Lock included"],
        popular: true,
      },
    ],
  },
  {
    ...
    units: [
      {
        tier: "Good", tierColor: "#718096", price: 89,
        label: "Standard",
        detail: "Back of facility, upper floor, interior access",
        features: ["Interior access", "Upper floor", "Lock included"],
      },
      {
        tier: "Better", tierColor: "#032046", price: 109, was: 129,
        label: "Climate-Controlled",
        detail: "Climate-controlled, ground floor, interior hallway",
        features: ["Climate-controlled", "Ground floor", "Interior access", "Lock included"],
        popular: true,
      },
      {
        tier: "Best", tierColor: "#1A8F60", price: 129,
        label: "Climate-Controlled Premium",
        detail: "Climate-controlled, near elevator, ground floor, wide aisle",
        features: ["Climate-controlled", "Near elevator", "Ground floor", "Wide aisle", "Lock included"],
      },
    ],
  },
  {
    ...
    units: [
      {
        tier: "Good", tierColor: "#718096", price: 129,
        label: "Standard Drive-Up",
        detail: "Back of facility, ground level, drive-up access",
        features: ["Drive-up", "Ground floor", "Lock included"],
      },
      {
        tier: "Better", tierColor: "#032046", price: 159, was: 179,
        label: "Climate-Controlled",
        detail: "Climate-controlled, ground floor, interior access",
        features: ["Climate-controlled", "Ground floor", "Interior access", "Lock included"],
        popular: true,
      },
      {
        tier: "Best", tierColor: "#1A8F60", price: 189,
        label: "Climate-Controlled Premium",
        detail: "Climate-controlled, nearest to loading dock, oversized door",
        features: ["Climate-controlled", "Near loading dock", "Oversized door", "Ground floor", "Lock included"],
      },
    ],
  },
  {
    ...
    units: [
      {
        tier: "Good", tierColor: "#718096", price: 179,
        label: "Standard Drive-Up",
        detail: "Ground level, drive-up access, back of facility",
        features: ["Drive-up", "Ground floor", "Lock included"],
      },
      {
        tier: "Better", tierColor: "#032046", price: 209,
        label: "Wide Drive-Up",
        detail: "Wider aisle, mid-facility, ground level drive-up",
        features: ["Drive-up", "Wide aisle", "Ground floor", "Lock included"],
        popular: true,
      },
      {
        tier: "Best", tierColor: "#1A8F60", price: 239,
        label: "Premium Drive-Up",
        detail: "Nearest to facility entrance, extra-wide aisle, ground floor",
        features: ["Near entrance", "Extra-wide aisle", "Drive-up", "Ground floor", "Lock included"],
      },
    ],
  },
];
...
const card = { background: B.surface, border: "1.5px solid " + B.border, overflow: "hidden" };
  ...
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
      <div style={{ background: B.navy, position: "relative" }}>
        <div style={{ ...ctr, paddingTop: 60, paddingBottom: 80, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          <div>
...
const SearchView = ({ onFacility, onSelectUnit }) => {
  ...
  const tierColors = { Good: "#718096", Better: "#032046", Best: "#1A8F60" };
  const tierBg = { Good: "#F7F9FC", Better: "#EEF3FF", Best: "#E6F4EF" };
    ...
    <div style={{ ...ctr, padding: "32px 24px", fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "196px 1fr", gap: 20, alignItems: "start" }}>
        <div style={{ position: "sticky", top: 80 }}>
          ...
          <button onClick={() => onFacility(activeFac)} style={{ ...btnSec, width: "100%", marginTop: 4, fontSize: 12, padding: "8px 0" }}>
            View details
          </button>
        </div>
...
const FacilityView = ({ facility, onBack, onSelectUnit }) => {
  ...
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <div style={{ background: B.surface, borderBottom: "1px solid " + B.border }}>
        <div style={{ ...ctr, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", textAlign: "center" }}>
          {[
...
const CheckoutView = ({ onBack, onConfirm }) => {
  const [form, setForm] = useState({ card: "", expiry: "", cvv: "", name: "", email: "", phone: "" });
  const set = k => e => setForm(p => ({ ...p, [k]: e.target.value }));
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
      <div style={{ background: B.navy, padding: "20px 0 24px" }}>
        <div style={{ ...ctrNarrow, padding: "0 24px" }}>
          <button onClick={onBack} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.7)", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 6, marginBottom: 14, fontFamily: "inherit" }}>&lt; Back</button>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {["Contact", "Payment", "Done"].map((label, i) => (
              <div key={label} style={{ flex: 1 }}>
                <div style={{ height: 4, background: i === 0 ? "#fbbf24" : "rgba(255,255,255,0.2)", marginBottom: 4 }} />
                <div style={{ fontSize: 11, color: i === 0 ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.4)", fontWeight: 600 }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div>
            <div style={card}>
              ...
              <div style={{ padding: 20 }}>
                <div style={{ marginBottom: 14 }}><label style={lbl}>Email</label><input style={inp} type="email" placeholder="you@email.com" value={form.email} onChange={set("email")} /></div>
                <div><label style={lbl}>Phone</label><input style={inp} type="tel" placeholder="(555) 000-0000" value={form.phone} onChange={set("phone")} /></div>
              </div>
            </div>
            <div style={{ height: 1, background: B.border, margin: "20px 0", position: "relative" }}>
              <span style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", background: B.bg, padding: "0 10px", fontSize: 11, color: B.text3, fontWeight: 700, letterSpacing: "0.5px" }}>THEN</span>
            </div>
            <div style={{ ...card, marginBottom: 20 }}>
              ...
              <div style={{ padding: 20 }}>
                <div style={{ marginBottom: 14 }}>
                  ...
                  <input style={inp} type="text" placeholder="1234 5678 9012 3456" value={form.card} onChange={set("card")} />
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
                  <div><label style={lbl}>Expiry</label><input style={inp} type="text" placeholder="MM / YY" value={form.expiry} onChange={set("expiry")} /></div>
                  <div><label style={lbl}>CVV</label><input style={inp} type="text" placeholder="..." value={form.cvv} onChange={set("cvv")} /></div>
                </div>
                <div><label style={lbl}>Name on card</label><input style={inp} type="text" placeholder="Full name" value={form.name} onChange={set("name")} /></div>
              </div>
            </div>
          </div>
          <div style={{ position: "sticky", top: 80 }}>
            <div style={{ ...card, marginBottom: 16 }}>
              ...
              <div style={{ padding: "16px 18px" }}>
                ...
                <div style={{ borderTop: "1px solid " + B.border, paddingTop: 12 }}>
                  {[
                    { label: "Monthly rent", val: "$119.00" },
                    { label: "Admin fee (one-time)", val: "$25.00" },
                  ].map(row => (
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid " + B.border }}>
                    <span style={{ color: B.text2, fontSize: 14 }}>
                      Protection plan
                      <span style={{ fontSize: 10, fontWeight: 700, background: "#FEF2F2", color: "#991B1B", border: "1px solid #FCA5A5", borderRadius: 4, padding: "2px 7px", marginLeft: 6 }}>Required</span>
                    </span>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0", fontWeight: 700, fontSize: 16 }}>
                    <span>First month total</span><span>$156.00</span>
                  </div>
                </div>
              </div>
            </div>
            <button onClick={onConfirm} style={{ ...btn, width: "100%", padding: 15, fontSize: 16 }}>Pay $156.00 - Secure my unit</button>
  ...
  <div style={{ fontFamily: "'Open Sans', sans-serif" }}>
    ...
    <div style={{ ...ctrNarrow, padding: "40px 24px" }}>
      <div style={{ ...card, border: "2px solid " + B.navy, marginBottom: 24, padding: 22 }}>
        ...
        <div style={{ fontSize: 52, fontWeight: 700, color: B.navy, fontFamily: "monospace", letterSpacing: 10, marginBottom: 8 }}>4872</div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 32 }}>
        {[
          ...
          <div key={step.n} style={{ ...card, display: "flex", alignItems: "flex-start", gap: 16, padding: "16px 20px" }}>
      ...
      <div style={{ background: B.navy, padding: "22px 26px", display: "flex", alignItems: "center", gap: 18, marginBottom: 32 }}>
...
const Footer = () => (
  <footer style={{ background: "#021432", padding: "40px 0 24px", marginTop: "auto", fontFamily: "'Open Sans', sans-serif" }}>
    <div style={{ ...ctr, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32, paddingBottom: 32, borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
      {[
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F7F9FC", fontFamily: "'Open Sans', sans-serif", color: B.text, fontSize: 15, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1 }}>
        {view === "home"     && <HomeView onSearch={() => go("search")} />}
        {view === "search"   && <SearchView onFacility={handleFacility} onSelectUnit={() => go("checkout")} />}
        {view === "facility" && <FacilityView facility={selectedFacility} onBack={() => go("search")} onSelectUnit={() => go("checkout")} />}
        {view === "checkout" && <CheckoutView onBack={() => go("search")} onConfirm={() => go("confirm")} />}
